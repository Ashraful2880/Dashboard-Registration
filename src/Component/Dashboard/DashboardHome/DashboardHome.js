    ...
    return (
        <div className="container mx-auto">
            ...
            <div className=" grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
                ...
                {/* Card-2 */}
                <div className="bg-gradient-to-r from-gray-900 via-gray-700  to-gray-600 h-36 hover:bg-gradient-to-l rounded-md hover:scale-105 duration-500">
                    <div className="text-white h-full w-full flex flex-col items-center justify-evenly">
                ...
                {/* Card-3 */}
                <div className="bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-400 h-36 hover:bg-gradient-to-l rounded-md hover:scale-105 duration-500">
                    <div className="text-white h-full w-full flex flex-col items-center justify-evenly">
                ...
                {/* Card-4 */}
                <div className="bg-gradient-to-r from-orange-700 via-[#DE9827]  to-[#DE9827] h-36 hover:bg-gradient-to-l rounded-md hover:scale-105 duration-500">
                    <div className="text-white h-full w-full flex flex-col items-center justify-evenly">
                ...
                {/* Card-5 */}
                <div className="bg-gradient-to-r from-emerald-800 via-from-emerald-700  to-emerald-600 h-36 hover:bg-gradient-to-l rounded-md hover:scale-105 duration-500">
                    <div className="text-white h-full w-full flex flex-col items-center justify-evenly">
                ...
                {/* Card-6 */}
                <div className="bg-gradient-to-r from-pink-800 via-pink-700  to-pink-600 h-36 hover:bg-gradient-to-l rounded-md hover:scale-105 duration-500">
                    <div className="text-white h-full w-full flex flex-col items-center justify-evenly">

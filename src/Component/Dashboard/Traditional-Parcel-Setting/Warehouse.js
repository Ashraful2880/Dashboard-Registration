...
const Warehouse = () => {
    ...
    const pageCount = Math.ceil(warehouses?.length / dataPerPage);
    ...
    return (
        <div className="px-4 mx-auto">
            <h3 className="text-2xl font-bold mb-6 text-left">Warehouse</h3>
            <div className="border border-gray-200 py-5 rounded-md shadow-xl">
                {/* Generate Return Branch Transfer Section Design Here */}
                <h3 className="font-bold text-lg text-left px-10">Warehouse List</h3>
                        ...
                        <div className="shadow overflow-hidden rounded-lg">
                            <table className="min-w-full divide-y divide-x divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-x divide-gray-200 text-gray-900 text-center text-sm font-normal">
                                    {warehouses.slice(pagesVisited, pagesVisited + dataPerPage).map((deliveryParcel) => (
                ...
                <div className="lg:flex block justify-between items-center my-2 mx-10">
                    <div className="border border-green-700 px-2 py-1 rounded-md hidden lg:block">
                        <p>Showing <span className="font-semibold">{pagesVisited + 1}</span> to <span className="font-semibold">{warehouses.slice(0, pagesVisited + dataPerPage).length}</span> of <span className="font-semibold">{warehouses?.length}</span> Entries</p>
                    </div>

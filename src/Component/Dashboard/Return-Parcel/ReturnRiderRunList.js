...
import { faPrint, faCheck, faEye, faRefresh, faSearch, faPen, faFileExcel } from '@fortawesome/free-solid-svg-icons';
...
const ReturnRiderRunList = () => {
    ...
    return (
        <div className="px-10 mx-auto">
            <h3 className="text-2xl font-bold mb-6 text-left">Return Rider Run List</h3>
            <div className="border border-gray-200 pb-5 rounded-md shadow-xl">
                ...
                <div className="lg:flex block justify-between items-center my-2 mx-10">
                    <p className="border border-gray-300 px-4 py-1 rounded-md">Showing <span className="font-semibold">1</span> to <span className="font-semibold">{returnRiderRunList.slice(0, showData).length}</span> of <span className="font-semibold">{returnRiderRunList?.length}</span> Entries</p>
                    <div>
                        pagination Here
                    </div>
                </div>

    ...
    return (
        <div className="px-10 mx-auto">
            ...
            <div className="border border-gray-200 pb-5 rounded-md shadow-xl">
                        ...
                        <div className="shadow overflow-hidden rounded-lg">
                            <table className="min-w-full divide-y divide-x divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-x divide-gray-200 text-gray-900 text-center text-sm font-normal">
                                    {parcelPaymentLists.slice(0, showData).map((parcel) => (
                ...
                <div className="lg:flex block justify-between items-center my-2 mx-10">
                    <p className="border border-gray-300 px-4 py-1 rounded-md">Showing <span className="font-semibold">1</span> to <span className="font-semibold">{parcelPaymentLists.slice(0, showData).length}</span> of <span className="font-semibold">{parcelPaymentLists?.length}</span> Entries</p>
                    <div>
                        pagination Here
                    </div>
                </div>

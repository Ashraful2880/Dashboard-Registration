...
const GenerateDeliveryRiderRun = () => {
    ...
    return (
        <div className="px-10 mx-auto">
            <h3 className="text-2xl font-bold mb-6 text-left text-gray-500">Generate Delivery Rider Run</h3>
            <div className="lg:flex block justify-between w-full">
                <form className="border border-gray-200 py-5 rounded-md shadow-md lg:w-1/2 w-full lg:px-10 px-6 lg:mx-6 mx-0">
                    <h2 className="text-green-700 text-xl font-bold text-left lg:mb-10 mb-2">Delivery Run</h2>
                    <div className="flex items-center justify-between py-2 px-5 my-2 border rounded-md">
                        ...
                        <select
                            ...
                            <option defaultValue="Dhaka Tejgoan Branch">Omar Faruk</option>
                            <option defaultValue="Chattogram">Md. Tahmidur Rahman</option>
                            <option defaultValue="Mohammadpur">Istiyaq Hossain Chowdhury</option>
                            <option defaultValue="Tongi">Md. Ibrahim Khalil Ullah</option>
                            <option defaultValue="Malitola">Tafim Hossain</option>
                        </select>
                    </div>
                    <div className="flex items-center justify-between py-2 px-5 my-2 border rounded-md">
                        ...
                        <div className="shadow overflow-hidden rounded-lg">
                            <table className="min-w-full divide-y divide-x divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-x divide-gray-200 text-gray-900 text-center text-sm font-normal">
                                    {deliveryRidersRun.map((runParcel) => (
...
export default GenerateDeliveryRiderRun;